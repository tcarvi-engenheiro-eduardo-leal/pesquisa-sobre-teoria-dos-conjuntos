...
const config: Config = {
  ...
  tagline: 'Tutoriais de Teoria dos Conjuntos',
  ...
  projectName: 'TCARVI', // Usually your repo name.
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/tcarvi-engenheiro-eduardo-leal/pesquisa-sobre-teoria-dos-conjuntos',
          label: 'GitHub',
          position: 'right',
        },
      ],
